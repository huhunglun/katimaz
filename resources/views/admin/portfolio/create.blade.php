...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{__('label.portfolio')}}</div>

                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.portfolio.add') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control{{ $errors->has('img') ? ' is-invalid' : '' }}" name="img" id="img" required>
                                @if ($errors->has('img'))
                                    <span class="invalid-feedback">
