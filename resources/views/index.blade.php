...
<head>
    ...
    <title>Katimazs`2 - Technology is the future</title>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="contents text-center">
                    <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Katimaz - Technology is the future</h1>
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="copyright">
                    <p>All copyrights reserved &copy; 2018 - Designed & Developed by <a rel="nofollow" href="http://katimaz.com">Katimaz</a></p>
                </div>
            </div>
        </div>
    </div>
